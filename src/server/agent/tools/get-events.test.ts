...
import { getUserEvents } from './get-events';
...
describe('getUserEvents', () => {
  ...
  it('should transform multiple events with different types', async () => {
    const { fetchAllPages } = await import('./fetch-pages');
    vi.mocked(fetchAllPages).mockResolvedValue([
      { id: '1', type: 'PushEvent', repo: { name: 'a/b', url: '' }, payload: {}, created_at: '2024-01-01T00:00:00Z' },
      { id: '2', type: 'ForkEvent', repo: { name: 'c/d', url: '' }, payload: {}, created_at: '2024-01-02T00:00:00Z' },
      { id: '3', type: 'CreateEvent', repo: { name: 'e/f', url: '' }, payload: {}, created_at: '2024-01-03T00:00:00Z' },
    ]);
